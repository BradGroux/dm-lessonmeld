...
public enum AgentManifestBuilder {
    ...
    public static func defaultCommands() -> [AgentCommand] {
        [
            ...
            AgentCommand(name: "connectors common-cartridge package", summary: "Create a local Common Cartridge package."),
            AgentCommand(name: "connectors scorm package", summary: "Create a local SCORM package."),
            AgentCommand(name: "connectors xapi package", summary: "Create a local xAPI activity package."),
            AgentCommand(name: "connectors video-host handoff", summary: "Create manual video-host upload metadata bundles."),
