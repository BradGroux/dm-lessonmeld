...
1. Common Cartridge export
   ...
   - Status: initial local package builder available through core and CLI.
...
2. SCORM package export
   ...
   - Status: initial SCORM 1.2-style package builder available through core and CLI; target LMS validation remains required before conformance claims.
...
3. xAPI activity package
   ...
   - Status: initial activity package and fixture statement export available through core and CLI.
...
4. Video-host publish handoff
   ...
   - Status: initial manual handoff bundle with host metadata profiles available through core and CLI.
...
5. H5P feasibility spike
   ...
   - Status: feasibility decision documented in [H5P Feasibility](H5P_FEASIBILITY.md); implementation deferred.
...
6. LTI 1.3 deep-link connector
   ...
   - Status: design documented in [LTI 1.3 Connector Design](LTI_1_3_DESIGN.md); implementation deferred until a hosted endpoint exists.
