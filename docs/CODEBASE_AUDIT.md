...
- Keep release notes explicit about signing status; unsigned tags are allowed only when the repository release mode is intentionally set to `unsigned-preview`.
