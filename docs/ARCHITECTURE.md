...
- The support target owns app-adjacent pure workflow logic such as project render planning, quick-recording completion render/package decisions, caption/transcript sidecar export, and typed project-editor dirty-state transitions.
