...
- Broad binary distribution should use Developer ID signing and notarization.
- Release artifacts should include a zip and SHA256 checksum.
...
- Signed/notarized distribution and DMG packaging.
